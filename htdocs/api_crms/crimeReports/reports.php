...
$stmt = $connector->prepare("INSERT INTO crime_reports (people_id, forum, description, image_urls) VALUES (?, ?, ?, ?)");
$stmt->bind_param("isss", $people_id, $forum, $description, $image_urls_json);
